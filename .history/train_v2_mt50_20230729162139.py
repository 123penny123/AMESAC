...
from policy import SACNetwork, MTSACNetwork, MLPrepresentation, MTMHSACNetwork, MixExpertAttentionSACNetwork,CARESACNetwork
from agent import SAC_Agent, MTSAC_Agent
...
if __name__ == "__main__":
    env_config = setup(config_path="./config/mt50.yaml")
    agent_config = setup(config_path="./config/mtmesac.yaml")
